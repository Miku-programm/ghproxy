...
# 获取最新版本号
VERSION=$(curl -s https://raw.githubusercontent.com/Miku-programm/ghproxy/main/DEV-VERSION)
wget -q -O ${ghproxy_dir}/VERSION https://raw.githubusercontent.com/Miku-programm/ghproxy/main/DEV-VERSION
